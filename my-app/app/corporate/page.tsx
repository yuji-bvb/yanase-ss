...
export const metadata: Metadata = {
  title: "会社概要",
  description: "簗瀬製作所の会社概要のページです。プレス加工による自動車部品等の製造及び溶接加工を行っています。",
};
...
export default function Corp() {
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="pt-5">プレス加工による自動車部品等の製造及び溶接加工</td>
    </tr>
    <tr>
      <td className="pt-5">主要取引先　　</td>
      <td className="pt-5">清水工業(株)　(株)赤池工業　青木電器工業(株)　他5社</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td className="pt-5"><Link className="underline underline-offset-1" href="tel:0425577450">042-557-7450</Link></td>
    </tr>
    <tr>
